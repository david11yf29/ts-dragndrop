...
define("components/project-list", ["require", "exports", "models/project", "components/base-component", "decorators/autobind", "state/project-state", "components/project-item"], function (require, exports, project_js_1, base_component_js_3, autobind_js_3, project_state_1, project_item_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectList extends base_component_js_3.Component {
        ...
        dropHandler(event) {
            ...
            project_state_1.projectState.moveProject(prjId, this.type === 'active' ? project_js_1.ProjectStatus.Active : project_js_1.ProjectStatus.Finished);
        }
        dragLeaveHandler(_) {
            const listEl = this.element.querySelector('ul');
